      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <Grid
            ...
            md
            textAlign="center"
            className="flex flex-row items-center !justify-center gap-1 lg:gap-4"
          >
            <Link
              href="/CreatorPanel"
          ...
          <Grid item xs={12} md="auto">
            ...
            >
              <IconButton
                href="https://www.linkedin.com/company/105713554/admin/dashboard/"
                target="_blank"
                sx={{
                  color: "#46C190",
                  "&:hover": {
              ...
              <IconButton
                href="https://www.instagram.com/airena.app"
                target="_blank"
                sx={{
                  color: "#46C190",
                  "&:hover": {
              ...
              <IconButton
                href="https://www.facebook.com/61572648736754/"
                target="_blank"
                sx={{
                  color: "#46C190",
                  "&:hover": {
        ...
        {/* Divider Line */}
        <Box
          sx={{ borderBottom: "1px solid rgba(255, 255, 255, 0.1)", my: 0.4 }}
        />
