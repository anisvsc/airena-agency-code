...
export const Frame = ({ className, ...props }) => {
  return (
    <div className={"frame " + className}>
      <img className="clip-path-group" src="clip-path-group0.svg" />

      <img className="white-1-1" src="white-1-10.png" />
      ...
      <div className="frame-1">
        ...
        <div className="welcome-to-atrena-the-next-generation-streaming-platform-for-gamers-and-sports-enthusiasts-join-our-community-and-start-streaming-today">
          ...
          and sports enthusiasts. Join our community and start streaming
          today.{" "}
        </div>
      ...
      {/* <VideoSec/> */}
      <img className="rectangle-145" src="rectangle-1450.svg" />
      <img className="rectangle-146" src="rectangle-1460.svg" />

      <img className="rectangle-147" src="rectangle-1470.svg" />
      <img className="rectangle-148" src="rectangle-1480.svg" />
    </div>
  );
};
