...
const Seek = React.forwardRef(({ children, ...props }, forwardedRef) => (
  <Player.Seek ref={forwardedRef} {...props}>
    <Player.Track className="bg-white/70 relative flex-grow rounded-full h-[2px]">
      <Player.SeekBuffer className="absolute bg-white/50 rounded-full h-full" />
...
const Loading = React.forwardRef(({ children, ...props }, forwardedRef) => {
  return (
    <div
      {...props}
