          ...
          <Stack spacing={2}>
            ...
            {currentPoll?.options?.map((option, index) => (
              ...
              >
                ...
                <IconButton
                  onClick={() => {
                    const newOptions = currentPoll.options.filter(
                      (_, i) => i !== index,
                    );
                    const newVotes = currentPoll.votes.filter(
                      (_, i) => i !== index,
                    );
                    setCurrentPoll((prev) => ({
                      ...prev,
            ...
            <Stack direction="row" spacing={2}>
              <Button onClick={addOption} variant="outlined" color="success">
                Add Option
              </Button>
              <Button onClick={submitPoll} variant="contained" color="primary">
