...
const UserQuiz = ({ playbackId }) => {
  ...
  if (!quiz) {
    return (
      <Box sx={{ textAlign: "center", color: "text.secondary" }}>
        <Typography variant="body1">No active quiz at the moment</Typography>
      </Box>
    );
  }
  ...
  if (!quiz.active) {
    return (
      <Box sx={{ textAlign: "center", color: "text.secondary" }}>
        <Typography variant="body1">This quiz has ended</Typography>
      </Box>
    );
  }
            ...
            <Typography variant="body1" fontWeight="bold">
              Quiz submitted! Your score:{" "}
              {
                Object.keys(userAnswers).filter((qIndex) =>
                  quiz.questions[qIndex].correctAnswers.includes(
                    userAnswers[qIndex],
                  ),
                ).length
              }{" "}
