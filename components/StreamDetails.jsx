  ...
  return (
    <Box mt={4} component={Paper} elevation={3} padding={2}>
      ...
      <Typography variant="body1" color="text.secondary" paragraph>
        Copy and paste the stream key into your streaming software. Use either
        the RTMP or SRT ingest, depending on your use-case.
      </Typography>
      ...
      <Box mt={3}>
        ...
        <CopyButton
          streamKey={`srt://rtmp.livepeer.com:2935?streamid=${streamKey}`}
        />
      </Box>
