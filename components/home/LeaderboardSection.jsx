            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-800 bg-black/80">
                  <th className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-medium">
                    Rank
                  </th>
                  <th className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-medium">
                    Player
                  </th>
                  <th className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-right text-xs sm:text-sm font-medium">
                    Score
                  </th>
                  <th className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-right text-xs sm:text-sm font-medium">
                    Prize
                ...
                {leaderboardData.map((item, index) => (
                  ...
                  >
                    <td className="px-2 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4">
                      <span
                        className={`${index < 3 ? "text-green-400" : "text-gray-400"} text-xs sm:text-sm font-medium`}
                      >
                        {item.rank}
                      </span>
                    </td>
