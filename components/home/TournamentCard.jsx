      ...
      <div className="flex flex-col md:flex-row h-full">
        ...
        <div className="relative w-full md:w-1/3">
          <div className="absolute top-0 left-0 h-full w-full z-10">
            <div className="absolute top-10 left-6 rotate-90 text-green-500 font-bold tracking-wider">
              PHOENIX
            </div>
        ...
        <div className="relative w-full md:w-1/3">
          <div className="absolute top-0 right-0 h-full w-full z-10">
            <div className="absolute top-10 right-6 rotate-90 text-green-500 font-bold tracking-wider">
              SAGE
            </div>
